...
- project-detector.ts:153 contradicts validator.ts:207 on .uproject Modules validation (detector rejects missing Modules, validator accepts it). P0 FIX candidate.
